...
public class HolidayCashWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(HolidayCashWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/MerryLittleCashmasWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/MerryLittleCashmasWLAIW/InitOutcome.xml").getDocumentElement();
